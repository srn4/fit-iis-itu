    ...
    const fetchInterests = async () => {
      try {
        const [allInterestsResponse, userInterestsResponse] = await Promise.all([
          ...
          axios.get<{ user_interests: UserInterest[] }>(`${apiUrl}/api/user-interests`, {
        ...
        setSelectedInterests(
          userInterestsResponse.data.user_interests.map((ui: UserInterest) => ui.interest_id)
        );
      } catch (error) {
...
const currentUserId = user.id;
    ...
    // Optionally: display a success message or handle post-save logic
  };
